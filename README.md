...
Sample usage:
```
sqllineage parse --file="D:\dev\sp_sample2.sql" --schema=testschema --database=testdb --output-file="C:\test.json"
```
...
### Input
Using the following parameters: ```sqllineage parse --file="C:\Users\User\Documents\SQL\testing\sample_query.sql" --schema="dbo" --database="TestDB" --output-file="C:\Users\User\Documents\SQL\testing\output\out.json"```
sample_query.sql:
```
